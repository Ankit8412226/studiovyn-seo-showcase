    ...
    <section className="py-14 sm:py-16 bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-6">
          <h2 className="text-2xl sm:text-3xl font-bold font-secondary">Case Study Spotlight</h2>
          <Link href="/case-studies" className="text-blue-600 font-medium">View all</Link>
        </div>
        <div className="grid sm:grid-cols-3 gap-4">
          {items.map((it) => (
            <Link key={it.slug} href={`/case-studies/${it.slug}`} className="p-5 rounded-xl bg-white border border-gray-100 shadow-sm hover:shadow-md transition">
